...
@media (max-width: 1030px) {
  .nav-primary #menu-menu-principal li {
...
<header id="top-anchor" class="banner">
  <div class="container-fluid">
    ...
    <nav class="nav-primary">
      ...
      <div class="transactionnal" style="margin-top:-5px;">
        <ul>
          ...
          <li><a href="<?php echo $woocommerce->cart->get_cart_url(); ?>"><img src="<?php echo get_template_directory_uri(); ?>/dist/images/cart.svg" class="cart-icon" alt="<?php _e('cart page','zenit') ?>"/></a></li>
        </ul>
      </div>
