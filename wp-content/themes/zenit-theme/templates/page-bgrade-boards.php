<?php
/**
 * Template Name: Template : B Grade Boards
 */
?>
...
<section id="product-list" class="container-fluid">
	...
	if (get_field('selected_cat', 20626)) :
		$terms       = get_field('selected_cat', 20626);
		...
		foreach($terms as $term): ?>
			<div class="row">
				<div id="<?php echo $term->slug; ?>" class="col-sm-12">
					...
					<h2><?php echo $currentLang === 'fr' ? 'Boards Grade B' : 'B Grade Boards'; ?></h2>
					...
					<div class="col-sm-3 col-xs-6 default-product">
						<div class="content-default">
							...
							<div class="image-product">
								<img class="lazy" data-original="<?php echo get_the_post_thumbnail_url($product->ID, array(375, 500)); ?>" width="375" height="500">
							</div>
