								...
								<div class="hover">
									<div class="cont">
										...
										<div class="btn-boards">
											<!--<button class="btn-acheter"><?php echo _e('Acheter','sage'); ?></button>-->
											<button class="btn-acheter" onclick="window.location.href='<?php echo $urlSingle; ?>'"><?php echo _e('Info','sage'); ?></button>
											<button style="margin-left: 20px;" class="btn-acheter" onclick="window.location.href='<?php echo $urlSingle . "#bottom-sale-section"; ?>'"><?php echo get_field('buy_button'); ?></button>
