<?php
/**
 * Template Name: Template : Accessoires
 */
?>
...
<section id="product-list" class="container-fluid">
	...
	if (get_field('selected_cat', 8258)) :
		$terms       = get_field('selected_cat', 8258);
					...
					<div class="col-sm-3 col-xs-6 default-product">
						<div class="content-default">
							...
							<div class="image-product">
								...
								?>
								<img class="lazy" data-original="<?php echo get_the_post_thumbnail_url($product->ID, array( 500, 500)); ?>" width="500" height="500">
							</div>
